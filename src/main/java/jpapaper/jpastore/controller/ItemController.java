...
public class ItemController {
    ...
    public String ctreateForm(Model model) {
    ...
    public String update(@PathVariable("itemId") Long itemId, @ModelAttribute("form") BookForm form) {
        ...
        itemService.updateBook(
                itemId, form.getName(), form.getPrice(), form.getStockQuantity(), form.getAuthor(), form.getIsbn()
        );
